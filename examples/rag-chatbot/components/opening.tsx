      ...
      <div className="light:ring-ring:ring-border ring-ring/10 relative my-7 rounded-lg py-3.5 pl-[1.625rem] pr-4 ring-1 ring-inset [--callout-border:theme(colors.indigo.400)] [--callout-icon:theme(colors.indigo.400)] [--callout-title:theme(colors.indigo.400)] dark:[--callout-border:theme(colors.indigo.400)] dark:[--callout-icon:theme(colors.indigo.400)] dark:[--callout-title:theme(colors.indigo.400)] [&>*]:my-0 [&>*]:py-0">
        ...
        <div className="mt-2">
          <header className="mb-8">
            <h4 className="text-foreground mt-4 flex gap-1 text-sm tracking-wide sm:text-base">
              <span>RAG Chatbot using</span>
              <Link
                target="_blank"
            ...
            <h5 className="text-muted-foreground text-sm">
              Build a RAG chatbot to talk to your documents using Langbase.
            </h5>
          </header>
          ...
          <div className="mt-4 flex flex-col gap-4 text-sm [&>p]:my-0 [&>p]:py-0">
            ...
            <div className="mt-2 flex flex-col gap-4 text-sm">
              ...
              <Dlink href="https://github.com/LangbaseInc/langbase-examples/tree/main/examples/rag-chatbot">
                <span>2.</span>
              ...
              <Dlink href="https://langbase.com/docs/pipe/quickstart">
                <span>3.</span>
                <span>Go through Documentation: Pipe Quickstart </span>
              </Dlink>

              <Dlink href="https://langbase.com/docs/memory/quickstart">
                <span>4.</span>
