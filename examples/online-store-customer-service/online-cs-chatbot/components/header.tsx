  ...
  return (
    <header className="bg-background sticky top-0 z-50 flex h-16 w-full shrink-0 items-center justify-between px-4">
      ...
      <div className="flex items-center justify-end space-x-2">
        <a
          target="_blank"
          href="https://github.com/LangbaseInc/langbase-examples/tree/main/examples/online-store-customer-service"
        ...
        <a
          target="_blank"
          href="https://beta.langbase.com/examples/online-store-customer-service"
          rel="noopener noreferrer"
