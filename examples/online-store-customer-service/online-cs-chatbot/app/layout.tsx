...
export const metadata: Metadata = {
  title: 'Online Store Customer Service Chatbot - Langbase',
  description: 'Build an Online Store Customer Service Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['Online Store Customer Service', 'Chatbot', 'Langbase']
}
