...
export const metadata: Metadata = {
  title: 'Pseudocode Generator Chatbot - Langbase',
  description: 'Build a Pseudocode Generator Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['Pseudocode Generator', 'Chatbot', 'Langbase']
}
