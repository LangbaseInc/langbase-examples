        ...
        <div className="mt-2">
          <header className="mb-8">
            <h4 className="text-foreground text-sm sm:text-base mt-4 flex gap-1 tracking-wide">
              <span>Product Review Generator Chatbot by a</span>
              <Link
                target="_blank"
                className="underline hover:text-indigo-400 mb-2"
                href="https://beta.langbase.com/examples/product-review-generator"
              >
          ...
          <div className="mt-4 flex flex-col gap-4 text-sm [&>p]:my-0 [&>p]:py-0">
            ...
            <div className="flex flex-col gap-4 mt-2 text-sm">
              <Dlink href="https://beta.langbase.com/examples/product-review-generator">
                <span>1.</span>
                <span>Fork this Product Review Generator Chatbot Pipe on ⌘ Langbase</span>
              </Dlink>
              <Dlink href="https://github.com/LangbaseInc/langbase-examples/tree/main/examples/product-review-generator">
                <span>2.</span>
