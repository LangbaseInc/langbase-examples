...
export const metadata: Metadata = {
  title: 'Product Review Generator Chatbot - Langbase',
  description: 'Build a Product Review Generator Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['Product Review Generator', 'Chatbot', 'Langbase']
}
