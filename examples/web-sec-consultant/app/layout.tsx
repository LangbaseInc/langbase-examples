...
export const metadata: Metadata = {
  title: 'Web Security Consultant (OWASP) Chatbot - Langbase',
  description: 'Build a Web Security Consultant (OWASP) Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['Web Security Consultant', 'Chatbot', 'Langbase']
}
