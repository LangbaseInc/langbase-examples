![Web Security Consultant (OWASP) Chatbot image by ⌘ Langbase][cover]
...
- 💬 [Web Security Consultant (OWASP) Chatbot][demo] — Built with an [AI Pipe on ⌘ Langbase][pipe]
...
1. Check the [Web Security Consultant (OWASP) Chatbot Pipe on ⌘ Langbase][pipe]
...
1. Fork the [Web Security Consultant (OWASP) Chatbot][pipe] Pipe on ⌘ Langbase.
...
[demo]: https://web-sec-consultant.langbase.dev
[lb]: https://langbase.com
[pipe]: https://beta.langbase.com/examples/web-sec-consultant
[gh]: https://github.com/LangbaseInc/langbase-examples/tree/main/examples/web-sec-consultant
[cover]:https://raw.githubusercontent.com/LangbaseInc/docs-images/main/examples/web-sec-consultant/web-sec-consultant.png
[download]:https://download-directory.github.io/?url=https://github.com/LangbaseInc/langbase-examples/tree/main/examples/web-sec-consultant
