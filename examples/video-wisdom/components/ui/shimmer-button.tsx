...
const ShimmerButton = ({
	...
	borderRadius = '100px',
	background = 'radial-gradient(ellipse 80% 50% at 50% 120%,rgba(12, 11, 17),rgba(18, 18, 38))',
	className,
	children,
	...props
}: ShimmerButtonProps) => {
	return (
		<button
			...
			className={cn(
				...
				'transition-all hover:scale-105 hover:shadow-[0_0_40px_8px_rgba(2,1,7,0.7)] duration-300',
				className
			)}
			{...props}
		>
