				...
				<div className="max-w-4xl mx-auto px-6 py-4">
					<div className="flex flex-col gap-4 md:flex-row items-center justify-between">
						<div className="flex items-center gap-3">
							<div className="w-10 h-10 bg-black rounded-full hidden sm:flex items-center justify-center">
								<IconMemory className="h-5 w-5 text-white" />
							</div>
							<div>
								<h1 className="text-xl font-semibold text-gray-900 tracking-tight text-center sm:text-left">Therapeutic Assistant</h1>
