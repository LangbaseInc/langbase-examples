...
export const metadata: Metadata = {
  title: 'DevScreener Chatbot - Langbase',
  description: 'Build an AI-Assistant DevScreener to support your HR for initial developer screening with ⌘ Langbase using any LLM model.',
  keywords: ['DevScreener', 'Chatbot', 'Langbase']
}
