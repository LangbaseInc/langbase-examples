...
- 💬 [Web API Security Consultant Bot][demo] — Built with an [AI Pipe on ⌘ Langbase][pipe]
...
1. Check the [Web API Security Consultant Bot on ⌘ Langbase][pipe]
...
1. Fork the [Web API Security Consultant Bot][pipe] Pipe on ⌘ Langbase.
...
[gh]: https://github.com/LangbaseInc/langbase-examples/tree/main/examples/api-sec-consultant
[download]:https://download-directory.github.io/?url=https://github.com/LangbaseInc/langbase-examples/tree/main/examples/api-sec-consultant
