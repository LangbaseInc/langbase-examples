				...
				<div className="mt-2">
					<header className="mb-8">
						<h4 className="text-foreground text-sm sm:text-base mt-4 flex gap-1 tracking-wide">
							<span>Tech Guide Writer</span>
							<Link
								target="_blank"
								className="underline hover:text-indigo-400 mb-2"
								href="https://langbase.com/langbase/tech-guide-writer"
							>
					...
					<div className="mt-4 flex flex-col gap-4 text-sm [&>p]:my-0 [&>p]:py-0">
						...
						<div className="flex flex-col gap-4 mt-2 text-sm">
							<Dlink href="https://langbase.com/langbase/tech-blog-writer">
								<span>1.</span>
								<span>
									Fork this Tech Guide Writer Pipe on ⌘ Langbase
								</span>
							</Dlink>
