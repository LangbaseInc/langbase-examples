...
export const metadata: Metadata = {
  title: 'ASCII Software Architect Chatbot - Langbase',
  description: 'Build an ASCII Software Architect Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['ASCII Software Architect', 'Chatbot', 'Langbase']
}
