...
export function MemorySidebar() {
  ...
  const [ownerLogin, setownerLogin] = useState('aiengine');
  ...
  return (
    <div className="w-64 bg-blend-normal p-4 flex flex-col space-y-4 fixed top-1/2 left-0 transform -translate-y-1/2 h-3/4 overflow-y-auto">
