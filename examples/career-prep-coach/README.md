![Career Prep Coach Chatbot by ⌘ Langbase][cover]

![License: MIT][mit] [![Fork to ⌘ Langbase][fork]][pipe]

## Build an Career Prep Coach Chatbot with Pipes — ⌘ Langbase
...
- 💬 [Career Prep Coach Chatbot][demo] — Built with an [AI Pipe on ⌘ Langbase][pipe]
...
1. Check the [Career Prep Coach Chatbot Pipe on ⌘ Langbase][pipe]
...
1. Fork the [Career Prep Coach Chatbot][pipe] Pipe on ⌘ Langbase.
