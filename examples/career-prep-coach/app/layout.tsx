...
export const metadata: Metadata = {
  title: 'Career Prep Coach Chatbot - Langbase',
  description: 'Build a Career Prep Coach Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['Career Prep Coach', 'Chatbot', 'Langbase']
}
