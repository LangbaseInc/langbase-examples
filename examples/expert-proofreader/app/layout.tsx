...
export const metadata: Metadata = {
  title: 'Expert Proofreader Bot - Langbase',
  description: 'Build Expert Proofreader Bot with ⌘ Langbase using any LLM model.',
  keywords: ['Expert Proofreader', 'Bot', 'Langbase']
}
