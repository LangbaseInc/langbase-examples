...
export const metadata: Metadata = {
  title: 'ParaphraseParrot Chatbot - Langbase',
  description: 'Build a ParaphraseParrot Chatbot with ⌘ Langbase using any LLM model.',
  keywords: ['ParaphraseParrot', 'Chatbot', 'Langbase']
}
